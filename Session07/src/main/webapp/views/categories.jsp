...
IntelliJ IDEA. User: This MC Date: 06/08/2024 Time: 9:07 PM To change this
      ...
      <tbody>
        <c:forEach items="${listCategories}" var="catalog" varStatus="loop">
          <tr>
            ...
            <td>
              <a
                href="<%=request.getContextPath()%>/CategoriesController?action=initUpdate&catalogId=${catalog.catalogId}"
                >Update</a
              >
              <a
                href="<%=request.getContextPath()%>/CategoriesController?action=Delete&catalogId=${catalog.catalogId}"
                >Delete</a
              >
            </td>
          </tr>
